...
## [0.87.3-pre](https://github.com/explorer2036/terraform-provider-snowflake/compare/v0.87.3-pre...v0.87.3-pre) (2024-03-20)
...
* add nill check for grant_helpers ([#1518](https://github.com/explorer2036/terraform-provider-snowflake/issues/1518)) ([87689bb](https://github.com/explorer2036/terraform-provider-snowflake/commit/87689bb5b60c73bfe3d741c3da6f4f544f16aa45))
...
* misc linting changes for 0.56.2 ([#1509](https://github.com/explorer2036/terraform-provider-snowflake/issues/1509)) ([e0d1ef5](https://github.com/explorer2036/terraform-provider-snowflake/commit/e0d1ef5c718f9e1e58e80d31bbe2d2f27afec486))
...
* multiple share grants ([#1510](https://github.com/explorer2036/terraform-provider-snowflake/issues/1510)) ([d501226](https://github.com/explorer2036/terraform-provider-snowflake/commit/d501226bc2ee8274446efb282c2dfea9599a3c2e))
...
* procedure and function grants ([#1502](https://github.com/explorer2036/terraform-provider-snowflake/issues/1502)) ([0d08ea8](https://github.com/explorer2036/terraform-provider-snowflake/commit/0d08ea85541ceff6e591d34a671b44ef778a6611))
...
* refactor for simplify handling error ([#1472](https://github.com/explorer2036/terraform-provider-snowflake/issues/1472)) ([3937216](https://github.com/explorer2036/terraform-provider-snowflake/commit/393721607c9eee5d73e14c27265eb39f195ccb37))
* refactor handling error to be simple ([#1473](https://github.com/explorer2036/terraform-provider-snowflake/issues/1473)) ([9f37b99](https://github.com/explorer2036/terraform-provider-snowflake/commit/9f37b997de073f01b66c86820237eff8049346ba))
* remove emojis, misc grant id fix ([#1598](https://github.com/explorer2036/terraform-provider-snowflake/issues/1598)) ([fdefbc3](https://github.com/explorer2036/terraform-provider-snowflake/commit/fdefbc3f1cc5bc7063f1cb1cc922854e8f9914e6))
...
* saml integration test ([#1494](https://github.com/explorer2036/terraform-provider-snowflake/issues/1494)) ([8c31439](https://github.com/explorer2036/terraform-provider-snowflake/commit/8c31439253d25aafb54fc09d89e547fa8238258c))
* schema name is optional for future file_format_grant ([#1484](https://github.com/explorer2036/terraform-provider-snowflake/issues/1484)) ([1450cdd](https://github.com/explorer2036/terraform-provider-snowflake/commit/1450cddde6328264f9df37e4dd89a78f5f095b2e))
* schema name is optional for future snowflake_stage_grant ([#1466](https://github.com/explorer2036/terraform-provider-snowflake/issues/1466)) ([0b4d814](https://github.com/explorer2036/terraform-provider-snowflake/commit/0b4d8146910e8ea31d2ed5ea8b58725449205dcd))
* schema read now checks first if the corresponding database exists ([#1568](https://github.com/explorer2036/terraform-provider-snowflake/issues/1568)) ([368dc8f](https://github.com/explorer2036/terraform-provider-snowflake/commit/368dc8fb3f7e5156d16caed1e03792654d49f3d4))
...
* support different tag association queries for COLUMN object types ([#1380](https://github.com/explorer2036/terraform-provider-snowflake/issues/1380)) ([546d0a1](https://github.com/explorer2036/terraform-provider-snowflake/commit/546d0a144e77c759cd6ddb91a193253f27f8fb91))
...
* update read role grants to use new builder ([#1596](https://github.com/explorer2036/terraform-provider-snowflake/issues/1596)) ([e91860a](https://github.com/explorer2036/terraform-provider-snowflake/commit/e91860ae794b034158b71ffb31097e73d8015c51))
